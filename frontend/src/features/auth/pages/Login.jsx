...
const Login = () => {
  ...
  const isEmailError = error?.toLowerCase().includes('email') || error?.toLowerCase().includes('found') || error?.toLowerCase().includes('exist')
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8 overflow-y-auto">
        <div className="w-full max-w-md">
          ...
          <div className="hidden lg:block mb-10">
            ...
            <p className="text-sm text-[#7a6a3a]">Enter your credentials to access your account.</p>
          </div>

          {/* ── Form Card ── */}
          <form
            onSubmit={handleSubmit}
            className="bg-[#141109] border border-[#2a2414] px-8 py-10 flex flex-col gap-8 flex-1"
          ...
          >
            ...
            <InputField
              ...
              errorMsg={isEmailError ? error : null}
            />
